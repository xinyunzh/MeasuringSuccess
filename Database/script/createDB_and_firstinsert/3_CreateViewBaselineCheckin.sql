...
(select d.*, e.accessemployment as accessemployment_baseline, e.employmentstatus as employmentstatus_baseline, e.employmentstartdate as employmentstartdate_baseline,
 ...
 fc.fincap_latefee as fincap_latefee_baseline, bcq.accessincome as accessincome_alltime, bcq.accessemployment as accessemployment_alltime, 
 bcq.accessfinancialcoach as accessfinancialcoach_alltime, bcq.bundledservices as bundledservices_alltime
...
left join wages w on w.wagesid = r.wagesid
 left join bundledservices_alltime_2019q1 bcq on bcq.clientid = r.clientid
