...
CREATE TABLE BundledServices_Alltime_2019Q3(
	agency varchar(50),
	ClientID varchar(50) primary key,
	quarter varchar(10),
	AccessIncome varchar(10),
...
insert into bundledservices_alltime_2019Q3
select d.agency, ba1.*
...
select * from BundledServices_Alltime_2019Q3;   ---8335
-----------------------------------------------------------------------------------
...
create table creditscore_recent_2019Q3(
agency varchar(50),
clientid varchar(50),
quarter_baseline varchar(10),
creditscore_baseline int,
...
insert into creditscore_recent_2019Q3
...
select * from creditscore_recent_2019Q3;    --8335
----------------------------------------------
...
create table wages_recent_2019Q3(
agency varchar(50),
clientid varchar(50),
quarter_baseline varchar(10),
wages_baseline int,
...
insert into wages_recent_2019Q3
...
select * from wages_recent_2019Q3;        --8335
