...
s16.employmentstatus as employmentstatus_2019Q1, s15.employmentstartdate as employmentstartdate_2019Q1
from 
...
select clientid, emp, emp_date,  date_part('year', age(now(),emp_date))*12+date_part('month', age(now(),emp_date)) as months
from employment_alltime_view;

																								  
create table employment_alltime_2019Q1(
...
insert into 	employment_alltime_2019Q1(																							  
select clientid, emp, emp_date, months, 
case 
...
when months >=12 and months <18 then 'More than 1 year but less than 1.5 year' 
when months >=18 and months <24 then 'More than 1.5 year but less than 2 year' 
