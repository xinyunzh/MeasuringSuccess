...
join financials f on f.financialsid = r.financialsid) to 'C:\Users\Leah Zhang\Desktop\database\exports\financialsall_cohort.csv' csv header;
...
join wages w on w.wagesid = r.wagesid) to 'C:\Users\Leah Zhang\Desktop\database\exports\wagesall_cohort.csv' csv header;
...
join employment e on e.employmentid = r.employmentid) to 'C:\Users\Leah Zhang\Desktop\database\exports\employmentall_cohort.csv' csv header;
...
from records r 
join bundledservices_checkin b on b.bundledservicesid = r.bundledservicesid) to 'C:\Users\Leah Zhang\Desktop\database\exports\bundledservices_cohort.csv' csv header;
